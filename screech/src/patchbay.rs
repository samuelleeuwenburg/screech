...
impl PatchPoint {
    ...
    pub fn value(&self) -> PatchPointValue {
        PatchPointValue { id: self.id }
    }
}
...
impl<const POINTS: usize> Patchbay<POINTS> {
    ...
    pub fn get_sample(&self, point: PatchPointValue) -> Result<Sample, PatchError> {
